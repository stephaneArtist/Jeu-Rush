...
/** \brief permet de connaître la colision entre 2 image
 *
 * \param img Image
 * \param img2 Image
...
/** \brief permet de connaître la collision entre 2 image (beaucoup plus rapide que ImgGetCollision mais ne prend pas en compte la rotation des image)
 *
 * \param img Image
 * \param img2 Image
 * \return bool renvoie true si il y a bien une colision entre les 2 image.
